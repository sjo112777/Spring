...
public class User1Controller {
    ...
    /*
        ...
        @Valid
         ...
         - 수신 처리되는 DTO의 각 속성 데이터를 유효성 검사 하기 위해 어노테이션 (@NOTBlank, @NOTEmpty, @NotNull, @Email...) 사용
    ...
    @PostMapping("/user1")
    public ResponseEntity<User1DTO> register(@Valid @RequestBody User1DTO user1DTO){ // 요청본문 내용에 포함된 데이터를 Java 객체로 변환하는 어노테이션, JSON 데이터 수신
