...
public class BoardRepositoryTest {
    ...
    public void test5() {
        ...
        /*
         엔티티가 관계설정 되어있을 경우에 해당 엔티티를 조회할 때 관계가 맺어진 다른 엔티티도 함께 조회되기 때문에
         단일 트랜젝션으로 처리해야 됨, 그렇지 않으면 no session 에러 발생 -> @Transactional 어노테이션 선언
         */
        ...
        /*
            ...
            엔티티간 toString 제귀호출로 인해 stackoverflow 에러 발생 -> @ToString에서 exclude 속성으로
            순환참조 되는 엔티티를 제외
         */
        /*
